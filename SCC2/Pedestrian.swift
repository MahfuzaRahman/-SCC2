...
//import Charts
//
//class Pedestrian: UIViewController {
//
//    let accGraphView = LineChartView()
//
//    var dataEntries = [ChartDataEntry]()
//
//    // Determine how many dataEntries shows up in the accGraph
//    var xValue: Double = 8
//
...
//        title = "PEDESTRIAN"
//
//        // Accelerometer Chart View setup
...
//        accGraphView.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
//        accGraphView.widthAnchor.constraint(equalToConstant: view.frame.width - 32).isActive = true
//        accGraphView.heightAnchor.constraint(equalToConstant: 300).isActive = true;
//
...
//        let newDataEntry = ChartDataEntry(x: xValue, y: Double.random(in: 0...50))
